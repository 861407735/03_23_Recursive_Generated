...
<head>
    ...
    %>
    <link rel="icon" href="${APP_PATH}/static/images/back.jpg" type="image/x-icon"/>
                    ...
                    <form id="add_boo_info_form">
                        ...
                        <div class="form-group">
                            ...
                            <select id="add_book_manager_select" name="operatorId">
                                ...
                                <option value="8013">是温宁啦</option>
                                <option value="8012">温宁哦</option>
                                <option value="8014">温宁嗷呜</option>
                            </select>
                        </div>
