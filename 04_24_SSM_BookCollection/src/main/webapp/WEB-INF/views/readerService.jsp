...
<head>
    ...
    %>
    <link rel="icon" href="${APP_PATH}/static/images/b" type="image/x-icon"/>
...
<%--                                <input id="add_reader_document_type_input" name="readerDocumentType" type="text" class="form-control" placeholder="证件类型：根据职业会自动确定...">--%>
                            ...
                            <div>
                                ...
                                <select class="form-control" id="reader_operator_id_select" name="operatorId">
                                    <option value="8013">温宁呀</option>
                                    <option value="8014">哇温宁哦</option>
                                    <option value="8015">温宁嗷呜</option>
                                    <option value="8011">温宁啦</option>
                                </select>
                            </div>
                            <!-- 7. 自动生成条形码 -->
                            <div>
                    ...
                    <form class="form-horizontal" id="update_reader_modal_form">
                        ...
                        <div>
                            ...
                            <select class="form-control" id="update_reader_operator_id_select" name="operatorId">
                                <option value="8015">温宁呀</option>
                                <option value="8012">哇温宁哦</option>
                                <option value="8013">温宁嗷呜</option>
                                <option value="8014">温宁啦</option>
                            </select>
                        </div>
                        <div>
